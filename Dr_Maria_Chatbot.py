...
def func(result):
  ...
  system_msg_template = SystemMessagePromptTemplate.from_template(template=""" You are Dr. Maria, an Orthopedic Specialist. After examining an X-ray report, it has been found that there is {result}. Please treat the patient accordingly and offer any further guidance as needed.""")                                                                        
